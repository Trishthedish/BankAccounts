...
module BankAccount
  ...
  class Account
    ...
    def self.getter
      ...
      CSV.open('support/accounts.csv').each do |column|
        print column
        @@account_arrays << self.new(column[0], column)
      end
    end
...
# Update the Account class to be able to handle all of these fields from the CSV file used as input.[ ]
      #example, manually choose the data from the first line of the CSV file and ensure you can create a new instance of your Account using that data[ ]
